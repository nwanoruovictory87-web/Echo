...
function NavigationBar() {
  ...
  function chat() {
    ...
    //*=============== main ui change
    chatBox.style.backgroundColor = "blue";
  ...
  function groups() {
    ...
    contactText.style.color = "black";
    //*=============== main ui change
    groupsBox.style.backgroundColor = "blue";
  ...
  function contacts() {
    ...
    groupsText.style.color = "black";
    //*=============== main ui change
    contactBox.style.backgroundColor = "blue";
    ...
    <>
      <div className="mt-6 mb-6">
        <div className="ml-5 flex bg-gray-200 mr-5 rounded-full">
          <span
            className="chat-box w-[40%] bg-blue-700 rounded-full text-center pl-2 pr-2 pt-1.5 pb-1.5"
            onClick={chat}
          >
            <h5 className="chat-text m-0 text-[16px] text-white font-sans text-center">
              All Chats
            </h5>
          </span>
          <span
            ...
            onClick={groups}
          >
            <h5 className="groups-text m-0 text-[16px] text-black font-sans text-center">
              Groups
            </h5>
          </span>
          <span
            ...
            onClick={contacts}
          >
            <h5 className="contact-text m-0 text-[16px] text-black font-sans text-center">
              Contacts
            </h5>
          </span>
        </div>
