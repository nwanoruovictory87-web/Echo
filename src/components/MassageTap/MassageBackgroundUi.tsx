    ...
    <>
      <div>
        <div className="relative">
          <div className="w-full h-[40.2px] bg-white fixed z-10 top-0"></div>
          <span className="block fixed w-screen h-[105.5px] bg-blue-700 mt-[40px] z-10"></span>
          <div className="w-[140px] h-[100px] bg-white rounded-bl-[85px] fixed z-10 mt-9 right-0">
            <span className="block w-[140px] h-[80px] rounded-bl-[40px] bg-white">
              <MassageVideoChat />
            </span>
            <span className="block w-[140px] h-[30px] rounded-tr-[80px] bg-blue-700"></span>
          </div>
          <span className="block fixed w-full h-[30px] bg-white right-0 mt-9"></span>
          <span className="block fixed w-[50%] h-[27px] rounded-tl-[60px] rounded-tr-[80px] bg-blue-700 right-0 mr-[140.5px] mt-[20px] z-10"></span>
          <span className="block fixed w-[50%] h-[27px] rounded-tl-[60px] rounded-tr-[80px] bg-blue-700 left-0 mr-[10px] mt-[20px] z-10"></span>
          <span className="fixed z-10 ">
            <MassageBackButton body={friendValue} />
          </span>
        </div>
        <div className="bg-blue-700 absolute w-full min-h-screen max-h-fit rounded-tl-[40px]">
          ...
          <div className="fixed bottom-0 bg-blue-700 pt-2 pb-8 w-[98%] pr-12 ">
            <div className="w-full ml-7 mr-7 flex">
              <span className="flex w-full h-14 pl-4 pr-4 pt-1 pb-1  rounded-full bg-white items-center">
              ...
              <span className="ml-3 bg-white rounded-full pl-3 pb-3 pr-4">
                <i
                  className="fa-solid fa-paper-plane mt-4  text-[25px] text-blue-700"
                  onClick={sendMassage}
                ></i>
              </span>
              {fileView && (
